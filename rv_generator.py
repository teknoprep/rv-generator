...
relay_start.request(consumer="rv-generator", type=gpiod.LINE_REQ_DIR_OUT, default_vals=[0])
relay_stop.request(consumer="rv-generator", type=gpiod.LINE_REQ_DIR_OUT, default_vals=[0])
...
# ==================================================
def main():
    print("RV Generator Controller starting (libgpiod)")
    ina_init()
